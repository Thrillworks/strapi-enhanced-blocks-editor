   ...
   */ const preventSelectFocus = (e)=>e.preventDefault();
    ...
    React.useEffect(()=>{
        if (editor.selection) {
            ...
            // Only sync blocks that appear in the selector; blocks like embedded-entry
            // set isInBlocksSelector: false and must not update the dropdown value.
            if (anchorBlockKey && blockKeysToInclude.includes(anchorBlockKey) && anchorBlockKey !== blockSelected) {
